...
//      moneyButton.link('https://www.youtube.com/watch?v=oHg5SJYRHA0');
//  });
...
function showStatus() {
    if (!gameStarted) {
        textArea.innerText = 'Welcome to Blackjack.\n\nNot to be confused with the mediocre comedian/actor, Jack Black.';
        return;
    }
...
if (gameOver) {
    if (playerWon) {
        ...
        textArea.innerText += "Dealer won, you suck!";
    }
